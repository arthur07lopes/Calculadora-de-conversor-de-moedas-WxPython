...
import wx
from funcoes_conversoes import obter_cotacoes_fixas, calcular_conversao
...
class MainFrame(wx.Frame):
    ...
    def init_UI(self):
        ...
        self.cb_destino = wx.ComboBox(panel, choices=list(self.moedas.values()), style=wx.CB_READONLY)
