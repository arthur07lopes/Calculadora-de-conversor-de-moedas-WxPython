...
class MainFrame(wx.Frame):
    ...
    def init_UI(self):
        ...
        self.cb_origem = wx.ComboBox(panel, choices=list(self.moedas.keys()), style=wx.CB_READONLY)
        ...
        self.btn_converter = wx.Button(panel, label="Converter")
        self.btn_converter.Bind(wx.EVT_BUTTON, self.btn_converter)
        sizer.Add(self.btn_converter, 0, wx.ALL | wx.EXPAND, 5)
